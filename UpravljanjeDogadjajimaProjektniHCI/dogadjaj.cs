...
namespace UpravljanjeDogadjajimaProjektniHCI
{
    ...
    public partial class dogadjaj
    {
        public dogadjaj()
        {
            this.fajls = new HashSet<fajl>();
            this.poddogadjajs = new HashSet<poddogadjaj>();
        }
        ...
        public virtual ICollection<fajl> fajls { get; set; }
        public virtual ICollection<poddogadjaj> poddogadjajs { get; set; }
